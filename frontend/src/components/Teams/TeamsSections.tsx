...
export const CreateTeamSection = ({
  ...
  return (
    <section className="rounded-2xl border border-[var(--border)] bg-[var(--bg)] p-5 shadow-sm">
      ...
      {isAlreadyOnTeam ? (
        <p className="mt-3 rounded-xl border border-amber-400/40 bg-amber-500/10 px-3 py-2 text-[13px] text-amber-900 dark:text-amber-100">
      ...
      <form className="mt-4 space-y-3" onSubmit={onFormSubmit}>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button type="submit" className={actionBtnClass} disabled={disableForm}>
